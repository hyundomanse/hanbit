...
public class AccountBean {
	 ...
	 * 
	 */
	public AccountBean() {// <- 생성자..  생성자 만드는 단축키 = ctrl + space
		// 6자리 랜덤 계좌번호
		this.setAccountNo();
	}
	...
	public void setAccountNo() {
		this.accountNo = (int)((Math.random()*999999)+100000); // *999999 = 6자리, +100000 = 6자리 숫자 중 가장 작은 숫자
	}
	...
	public String toString() {
		return BANK_NAME+ " [계좌번호 =" + accountNo+ " +, 이름 : " + ownerName + ", 비밀번호 : ********" + password
				+ ", 잔액 : " + restMoney + "]";
	}
