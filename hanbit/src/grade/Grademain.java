...
/**
 * 2016. 4. 16. Grademain.java shinhyundo story : 성적표 프로그램
 */
public class Grademain {
	/**
	 * [문제] 과목별 점수를 입력받아 총점, 평균, 학점을 구하는 프로그램을 완성하시오 (과목은 국,영,수)
	 */
	public static void main(String[] args) {
		...
		while (true) {
			...
			case 1:
				...
				// int kor = scanner.nextInt(), eng = scanner.nextInt(), math =
				// scanner.nextInt();
				// ----------[3.메소드 호출]------------------
				...
				// grd = grade.getGrade();
				// int total = grade.gettotal(kor, eng, math); 할 경우 상위에 int에서
				// total 삭제 가능.
				break;

			case 2:
				System.out.println("시스텝 종료");
				return;
